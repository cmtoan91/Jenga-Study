...
public class StackCreationMessage: GlobalMessage
{
    public StackHolder Stack;
    public StackCreationMessage(StackHolder stack)
    {
        Stack = stack;
    }
}

public class StackFunctionalitySetupMessage: GlobalMessage
{
    public Dictionary<string, Action> AllFunctionality = new Dictionary<string, Action>();
}

public class OnBlockSelectMessage: GlobalMessage
{
